...
func (c *userHandlerClient) List(ctx context.Context, in *ListReq, opts ...grpc.CallOption) (*ListTask, error) {
	out := new(ListTask)
	err := c.cc.Invoke(ctx, "/gprc.UserHandler/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userHandlerClient) Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
...
func (c *userHandlerClient) Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
...
func (c *userHandlerClient) Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
...
func (c *userHandlerClient) DeleteAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/gprc.UserHandler/DeleteAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserHandlerServer) List(context.Context, *ListReq) (*ListTask, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedUserHandlerServer) Get(context.Context, *GetReq) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedUserHandlerServer) Create(context.Context, *CreateReq) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserHandlerServer) Update(context.Context, *UpdateReq) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedUserHandlerServer) Delete(context.Context, *DeleteReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedUserHandlerServer) DeleteAll(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _UserHandler_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserHandlerServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gprc.UserHandler/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserHandlerServer).List(ctx, req.(*ListReq))
	}
...
func _UserHandler_DeleteAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserHandlerServer).DeleteAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gprc.UserHandler/DeleteAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserHandlerServer).DeleteAll(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserHandler_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "List",
			Handler:    _UserHandler_List_Handler,
		},
		{
			MethodName: "Get",
		...
		},
		{
			...
			Handler:    _UserHandler_DeleteAll_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "task/delivery/grpc/task.proto",
}
